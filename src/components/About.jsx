...
const About = () => {
    return (
        <div name='About' className=' outline-blue-500 h-auto min-h-[90vh] w-full bg-gradient-to-b to-black via-black from-gray-800 '>
            <div className='py-20 section justify-between'>
                ...
                <div className='flex flex-col justify-center w-full px-10 md:px-20 lg:px-28 text-white'>
                    ...
                    <div className='text-gray-400 py-4 space-y-3 md:space-y-2 md:pt-8 lg:pt-12 font-semibold text-justify'>
                        <p>
                            An aspiring Fullstack Web Developer mostly working with Frontend with React and Tailwind CSS.
                            I also love to make beautiful Web Applications with technologies like MERN Stack, NextJs.
                        </p>
                        <p>
                            Coding Enthusuast and Passionate Web Developer currently pursuing Bachelor's degree in computer Applications.
                        </p>
                    </div>
