                ...
                <div className='flex justify-center items-center'>
                    ...
                    >
                        <div className="relative w-full">
                            <input type="text" name="name" placeholder="Enter Your Name" className='form-input' value={formData.name} onChange={handleChange} />
                            <BsPersonFill size={20} className="text-white absolute left-3 top-1/2 -translate-y-1/2" />
                        </div>
                        <div className="relative w-full">
                            <input type="email" name="email" placeholder="Enter Your Email" className='form-input' value={formData.email} onChange={handleChange} />
                        ...
                        <div className="relative w-full">
                            <textarea name="message" placeholder='Your Meaasge' rows="10" cols="30"
                                className="form-input" value={formData.message} onChange={handleChange}
